--------------------------------- MODULE RaftWithReconfigSingleServer --------------------------------
\* 
\* This is an abstract formal specification of the Raft consensus algorithm with
\* dynamic reconfiguration.
\* 
\* It allows for reconfiguration using the single server membership change
\* protocol described in Raft. It models a version of the protocol that includes
\* the fix for the safety bug described in
